...
struct CItem
{
  ...
  void Convert(int item, BYTE Option1, BYTE Option2, BYTE Option3,BYTE Attribute2, BYTE SetOption, BYTE ItemEffectEx, BYTE DbVersion)
  {
	  _asm
	  {
	  mov al, DbVersion
...
struct OBJECTSTRUCT
{
	  ...
	  /*<thisrel this+0x1910>*/ /*|0x4|*/ char m_JewelOfHarmonyEffect[0x26];
	  /*<thisrel this+0x1910>*/ /*|0x4|*/ char m_ItemOptionExFor380[0x10];
	  ...
	  /*<thisrel this+0x1965>*/ /*|0x3|*/ unsigned char m_Filler0x1965[OBJECTARRAYFILER];
}; 
